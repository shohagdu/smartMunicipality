		...
		<?php if($_GET['napply']=='new'):?>
			<div class="col-lg-12 col-sm-12 col-xs-12" style="margin:10px 0px;">
				...
				<div class="col-lg-4 col-sm-4 col-xs-4">
					<button type="button" value="11&service=<?php echo $service;?>" name='acceptWaiting' onclick="filterServiceNewApplication(this.value);" class='btn btn-warning btn-sm'>Waiting for Accept</button>
