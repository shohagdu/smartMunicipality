				...
				<form name="tradeform" action="Genarate/tradelicenseGenarate_action" method="post" id="tradelicenseGenarate" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<?php if($invoice_data->signboard_fee != ''){ ?>
							<input type='checkbox' class="" name='sb_fee' id='recom' checked  value='1' />&nbsp;হাঁ
							<?php }else{ ?>
								<input type='checkbox' class="" name='sb_fee' id='recom'  disabled  value='1' />&nbsp;হাঁ
							<?php }?>
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-1" style="margin-top: 10px;">
						<?php if($invoice_data->signboard_fee != ''){ ?>
							<input type='checkbox' name='recom' id='suparish_chard' value='1' checked  />&nbsp;হাঁ
							<?php }else{ ?>
								<input type='checkbox' name='recom' id='suparish_chard' value='1'  disabled />&nbsp;হাঁ
							<?php }?>
						</div>
						<div class="col-sm-3">
