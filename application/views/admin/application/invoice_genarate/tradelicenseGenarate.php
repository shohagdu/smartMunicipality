<div id="content" class="col-lg-10 col-sm-10">
		...
		<div class="row">
			<div class="col-lg-12 col-sm-12">
				<h3 class="tit" style="margin-top:0px;margin-bottom: 20px;background:lightgray;padding:5px;text-align:center;">ট্রেড লাইসেন্স সনদ ফি ইনভয়েস তৈরি  </h3>
				<form name="tradeform" action="InvoiceGenerate/tradelicenseGenarate_action" method="post" id="" class="form-horizontal" role="form">
					<div class="form-group">
						<label class="control-label col-sm-2 highlisht_font" for="serial no"> নাম  :</label>
						<div class="col-sm-4">
							<input type="text" class="form-control highlisht_font" name="bwname" id="bwname" value='<?php echo $row->bwname?>' readonly />
						</div>
						<div class="clearfix visible-xs"></div>
						<label class="control-label col-sm-2 highlisht_font" for="traking no">মোবাইল :</label>
						<div class="col-sm-4">
