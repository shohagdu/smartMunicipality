        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="col-sm-8"><div class="row"><span style="font-size: 18px; font-weight: bolder;">বসতভিটার ট্যাক্সের  পেমেন্টর  তথ্য </span> </div></div>
                    <div class="col-sm-4">
                ...
                <form action="admin/searchHoldingPaymentHistoryList" id="holdingNoInfoFormBillId"><div class="clearfix"></div>
