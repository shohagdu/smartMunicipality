        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="col-sm-8"><div class="row">বসতভিটার রেজিস্ট্রেশন আপডেট </div></div>
                    <div class="col-sm-4">
                ...
                <form action="Admin/UpdatenewBosotbitaTaxCollection" method="post" id="" class="form-horizontal" ><div class="clearfix"></div>
                       
                        <div class="form-group">
							<label class="control-label col-sm-2 col-xs-4" style="text-align:right;">নাম  <span class="red-color">*</span></label>
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="name" id="name" class="form-control" value="<?php echo $holding_tax_person['data']->name?>" required>
							</div>
							<label class="control-label col-sm-2 col-xs-4" for="" style="text-align:right">পিতার নাম <span class="red-color">*</span></label>
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="fatherName" id="fatherName" class="form-control" value="<?php echo $holding_tax_person['data']->fathername?>">
							</div>
							<div class="clearfix"></div>
						</div>
                        <div class="form-group">
							...
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="village" id="village" class="form-control" value="<?php echo $holding_tax_person['data']->village?>">
							</div>
									...
									<?php 
										if($member_info['status'] === 'success'):
											foreach ($member_info['data'] as $row):
												?>
												<option value="<?php echo $row->word_no;?>" <?php if($holding_tax_person['data']->wordno == $row->word_no){ echo "selected";}?>> <?php echo $row->word_no .' ওয়ার্ড';?> </option>
												<?php 
											endforeach;
										endif;
									?>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="nationalId"  id="nationalId" class="form-control" placeholder="ইংরেজীতে প্রদান করুন"  value="<?php echo $holding_tax_person['data']->national_id?>"/>
							</div>
							<div class="visible-xs clearfix"></div>
							<label class="control-label col-sm-2 col-xs-4 " style="text-align:right">জন্ম নিবন্ধন নং <span class="red-color"></span></label>
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="birthCertificateId" id="birthCertificateId" class="form-control" placeholder="ইংরেজীতে প্রদান করুন" value="<?php echo $holding_tax_person['data']->birth_certificate_id?>" required/>
							</div>
							<div class="clearfix"></div>
						</div>
                        <div class="form-group">
							...
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="holdingNumber" id="holdingNumber" class="form-control" onkeypress="return numtest();" placeholder="ইংরেজীতে প্রদান করুন" value="<?php echo $holding_tax_person['data']->holding_no?>" required/>
							</div>
							<div class="visible-xs clearfix"></div>
							<label class="control-label col-sm-2 col-xs-4" style="text-align:right">দাগ নং <span class="red-color">*</span></label>
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="dagNo" id="dagNo" class="form-control" onkeypress="return numtest();" placeholder="ইংরেজীতে প্রদান করুন" value="<?php echo $holding_tax_person['data']->dag_no?>" />
							</div>
							<div class="clearfix"></div>
						</div>
                        <div class="form-group">
							...
							<div class="col-sm-4 col-xs-8">
								<select name="rateSheet" id="rateSheet" class="form-control" required>
									<option value="">চিহ্নিত করুন</option>
									<?php 
										if($rate_sheet['status'] === 'success'):
											foreach ($rate_sheet['data'] as $rate):
												?>
												<option value="<?php echo $rate->rid;?>" <?php if($holding_tax_person['data']->rate_sheet_id == $rate->rid ){ echo "selected";}?>> <?php echo $rate->rate_sheet_label .' ('. $rate->amount.' টাকা)'; ?> </option>
												<?php 
											endforeach;
										endif;
									?>
							...
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="mobileNo" id="mobileNo" class="form-control" maxlength="11" placeholder="ইংরেজীতে প্রদান করুন" value="<?php echo $holding_tax_person['data']->mobile_number?>">
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4 col-xs-8">
								<input type="text" name="due" id="due" class="form-control" onkeypress="return numtest();" placeholder="ইংরেজীতে প্রদান করুন" value="<?php echo $holding_tax_person['data']->due?>"/>
							</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-1 col-xs-4">
							    <input type="hidden" name="id" value="<?php  echo $holding_tax_person['data']->id; ?>">
