        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="col-sm-8"><div class="row">বসতভিটার  ট্যাক্সের এস এম এস  </div></div>
                    <div class="col-sm-4">
                ...
                <form action="admin/searchHoldingTaxSmsSend" id="holdingNoInfoFormId"><div class="clearfix"></div>
				<div class="row" style="margin-bottom: 20px;"> 
					<div class="form-group">
						<label class="col-sm-2" for="Fiscal year" style="font-size: 14px; font-weight: bolder;text-align:right"> অর্থ বছর </label>
						<div class="col-sm-2">
						...
						<label class="col-sm-2" for="" style="font-size: 14px; font-weight: bolder;"> বসতভিটার ধরন </label>
						<div class="col-sm-3">
