...
<div id="informationShow">
		<div class="panel-group">
			<div class="panel panel-info">
				<div class="panel-heading"> <span style="font-size: 15px;"> পেমেন্টর তালিকা </span></div>
				...
				<table class="table table-striped table-bordered dt-responsive nowrap">
					<tr>
						...
						<th style="text-align:center;"> পেমেন্ট তারিখ  </th>
						<th style="text-align:center;"> অর্থ বছর </th>
					...
					<tr>
						...
						<td><?php echo $item->rate_sheet_label ?></td>
						<td><?php echo ( $item->total +  $item->due_amount) - $item->discount?></td>
						<td><?php echo $item->mobile_number ?></td>
						<td><?php if($item->payment_date  != "0000-00-00"){ echo date('d-m-Y', strtotime($item->payment_date ));}?></td>
						<td><?php echo $item->FiscalYear ?></td>
						<td>
