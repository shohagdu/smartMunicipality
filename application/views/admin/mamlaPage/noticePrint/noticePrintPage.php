				...
				<div id="cert">
					...
					<table border='0' width="99%" height="34px" cellpadding='0' cellspacing='0' style="border-collapse: collapse;margin: 2px auto;table-layout:fixed;"> 
						<tr>
							...
							<td style="width: 25%;text-align:center;"><font style="font-size:10px !important;opacity:0.7;">   Developed by  Step Technology </font> <br><font style="font-size:12px !important;opacity:0.7;">www.steptechbd.com</font></td>
