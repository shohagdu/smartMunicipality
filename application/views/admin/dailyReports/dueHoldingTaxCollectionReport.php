...
<head>
    ...
    <title> অর্থ বছর অনুযায়ী বকেয়া ট্যাক্স ধারীর তালিকা</title>
...
if(empty($_GET['fiscal_year'])) {
    ...
    $param['receive.is_paid'] = 0;
    $param['receive.is_active'] != 0;
...
<div class="fix stracture wrapper1">
    <div class="fix top-side">
        <div class="fix heading">
            ...
            <p class="highilight">
                <span>অর্থ বছর অনুযায়ী বকেয়া ট্যাক্স ধারীর তালিকা</span>
            </p>
